...
<link href="<c:url value="/resources/assets/global/plugins/select2/select2.css"/>" rel="stylesheet" type="text/css"/>
<link href="<c:url value="/resources/assets/admin/pages/css/login.css"/>" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="<c:url value="/resources/assets/admin/layout/css/themes/default.css"/>" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN LOGO -->
<div class="logo">
	<img src="<c:url value="/resources/extras/kanteron-big.png"/>" alt=""/>
</div>
<!-- END LOGO -->
...
<script src="<c:url value="/resources/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"/>" type="text/javascript"></script>
...
<script src="<c:url value="/resources/assets/admin/pages/scripts/login.js"/>" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
